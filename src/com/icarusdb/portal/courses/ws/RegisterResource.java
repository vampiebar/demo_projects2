...
public class RegisterResource {
	...
	public String putOnKayit(@Context UriInfo info) {
		...
		return DBUtil.putOnKayit(adi, soyadi, tc_kimlik_no, cinsiyet,
				medeni_hali, dogum_tarihi, ev_telefonu, cep_telefonu, email,
				ogrenci_bilgileri_ulke, ogrenci_bilgileri_ilce,
				...
				adres_bilgileri_ilce, adres_bilgileri_ilce, semt, mahalle_koy,
				sokak_ve_no);
	}
	...
	@Path("getsaatgirisi")
	@Produces("application/xml")
	public List<SaatGirisi> getSaatGirisi() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<SaatGirisi> listSaatGirisi = DBUtil.getSaatGirisi();
	...
	public String putSaatGirisi(@Context UriInfo info) {
		...
		return DBUtil
				.putSaatGirisi(baslangic_saati, bitis_saati, gun, aciklama);
	}
	...
	@Produces("application/xml")
	public List<SinavTanimlama> getSinavTanimlama() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<SinavTanimlama> listSinavTanimlama = DBUtil.getSinavTanimlama();
	...
	public String putGelirlerveGiderler(@Context UriInfo info) {
		...
		return DBUtil.putGelirlerveGiderler(islem_tipi, kategoriler, gelirler,
				odeme_turu, banka, cek, vade_tarihi, miktar, tarih, aciklama);
	}
	...
	public String putGelirGiderTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putGelirGiderTanimlari(kategori_adi, tipi,
				gelir_gider_adi);
	}
	...
	public String putGelirGiderKategorileri(@Context UriInfo info) {
		...
		return DBUtil.putGelirGiderKategorileri(kategori_adi);
	}

	@GET
	@Path("getbankaekle")
	@Produces("application/xml")
	public List<BankaEkle> getBankaEkle() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<BankaEkle> listBankaEkle = DBUtil.getBankaEkle();
	...
	public String putBankaEkle(@Context UriInfo info) {
		...
		return DBUtil.putBankaEkle(banka_adi, banka_sube, hesap_no, iban_no,
				bankanin_odeme_sekli, vade_tarihi);
	}

	@GET
	@Path("getdbssinavtanimla")
	@Produces("application/xml")
	public List<DBSSinavTanimla> getDBSSinavTanimla() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<DBSSinavTanimla> listDBSSinavTanimla = DBUtil.getDBSSinavTanimla();
	...
	public String putDBSSinavTanimla(@Context UriInfo info) {
		...
		return DBUtil.putDBSSinavTanimla(okul_durumu, alan, sinav_tarihi, kota,
				bina_sekli);
	}
	...
	@Produces("application/xml")
	public List<OgretmenTanimlari> getOgretmenTanimlari() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<OgretmenTanimlari> listOgretmenTanimlari = DBUtil
				.getOgretmenTanimlari();
	...
	public String putOgretmenTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putOgretmenTanimlari(tc_kimlik_no, adi_soyadi,
	...
	@Produces("application/xml")
	public List<SinifTanimlari> getSinifTanimlari() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<SinifTanimlari> listSinifTanimlari = DBUtil.getSinifTanimlari();
	...
	public String putSinifTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putSinifTanimlari(sinif_adi, fiziksel_sinif_adi,
	...
	@Path("getindirimturu")
	@Produces("application/xml")
	public List<IndirimTuru> getIndirimTuru() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<IndirimTuru> listIndirimTuru = DBUtil.getIndirimTuru();
	...
	public String putIndirimTuru(@Context UriInfo info) {
		...
		return DBUtil.putIndirimTuru(indirim_turu, indirim_sekli,
				indirim_miktari);
	...
	@Produces("application/xml")
	public List<HizmetTanimla> getHizmetTanimla() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<HizmetTanimla> listHizmetTanimla = DBUtil.getHizmetTanimla();
	...
	public String putHizmetTanimla(@Context UriInfo info) {
		...
		return DBUtil.putHizmetTanimla(hizmet_adi, hizmet_turu, birim_fiyati);
	...
	@Path("getreferanslar")
	@Produces("application/xml")
	public List<Referanslar> getReferanslar() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<Referanslar> listReferanslar = DBUtil.getReferanslar();
	...
	public String putReferanslar(@Context UriInfo info) {
		...
		return DBUtil.putReferanslar(referans_adi_soyadi);
	...
	@Produces("application/xml")
	public List<PersonelTanimlari> getPersonelTanimlari() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<PersonelTanimlari> listPersonelTanimlari = DBUtil
				.getPersonelTanimlari();
	...
	public String putPersonelTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putPersonelTanimlari(adi_soyadi, gorevi,
	...
	@Produces("application/xml")
	public KurumsalBilgiler getKurumsalBilgiler() {
		// throw new UnsupportedOperationException("Not yet implemented.");

		return DBUtil.getKurumsalBilgiler();
	}
	...
	public String putKurumsalBilgiler(@Context UriInfo info) {
		...
		return DBUtil.putKurumsalBilgiler(sube_kisa_adi, sube_resmi_adi,
	...
	@Produces("application/xml")
	public List<DonemTanimlari> getDonemTanimlari() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<DonemTanimlari> listDonemTanimlari = DBUtil.getDonemTanimlari();
	...
	public String putDonemTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putDonemTanimlari(donem_adi, baslangic_tarihi,
	...
	@Produces("application/xml")
	public List<DersTanimlari> getDersTanimlari() {
		// throw new UnsupportedOperationException("Not yet implemented.");
		List<DersTanimlari> listDersTanimlari = DBUtil.getDersTanimlari();
	...
	public String putDersTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putDersTanimlari(egitim_turu_adi, alan_adi, ders_adi);
	}

	@GET
	@Path("getunitetanimlari")
	@Produces("application/xml")
	public List<UniteTanimlari> getUniteTanimlari() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<UniteTanimlari> listUniteTanimlari = DBUtil.getUniteTanimlari();
	...
	public String putUniteTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putUniteTanimlari(egitim_turu_adi, alan_adi, ders_adi,
				unite_adi);
	}
	...
	@Produces("application/xml")
	public List<KonuTanimlari> getKonuTanimlari() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<KonuTanimlari> listKonuTanimlari = DBUtil.getKonuTanimlari();
	...
	public String putKonuTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putKonuTanimlari(egitim_turu_adi, alan_adi, ders_adi,
				unite_adi, konu_adi);
	}
	...
	public String putFizikselSinifTanimlari(@Context UriInfo info) {
		...
		return DBUtil.putFizikselSinifTanimlari(fiziksel_sinif_adi);
	}
	...
	public String putKursZamaniTanimlama(@Context UriInfo info) {
		...
		return DBUtil.putKursZamaniTanimlama(kurs_zamani);
	}
	...
	@Produces("application/xml")
	public List<KullaniciTanimlama> getKullaniciTanimlama() {
		// throw new
		// UnsupportedOperationException("Not yet implemented.");
		List<KullaniciTanimlama> listKullaniciTanimlama = DBUtil
				.getKullaniciTanimlama();
	...
	public String putKullaniciTanimlama(@Context UriInfo info) {
		...
		return DBUtil.putKullaniciTanimlama(kullanici_kodu, adi, soyadi, sifre,
				sifre_tekrar);
	}
